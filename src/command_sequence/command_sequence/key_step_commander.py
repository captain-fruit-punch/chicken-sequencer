...
class SequenceCommander(Node):
    def __init__(self):
        ...
        ingredient_clearance = ('move', -0.01, 0.28, 0.34, 1.570, -0.05, 0.0)
        ...
        grill_0_flip = ('move', -0.41, 0.0, 0.09, -1.570, -0.1, 0.0)
        grill_0_clear_flip = ('move', -0.35, 0.1, -0.02, -1.570, -0.1, 0.0)
